...
public:
	...
	// Обработчик столкновений для статического и динамического объектов
	...
	Base(void) {
		...
		// ============================== //
		// Объявляем поля базового класса //
		// ============================== //
	...
	static GameConstatnts gc;			// Набор общих игровых констант
...
ResourcesManager		B::resources;	// Набор текстур, шрифтов, звуков и музыки (audio.sound.my_sound | audio.music.my_music)
sf::Event				B::event;		// Для обработчика событий while(wnd.pollEvent(event)) { Conditions... }
...
GameConstatnts			B::gc;			// Набор общих игровых констант
sf::Clock				B::clock;